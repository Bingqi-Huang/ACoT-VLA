...
export ACOT_SERVE_CONFIG=${ACOT_SERVE_CONFIG:-acot_challenge_generalist_continued_reweighted}
export ACOT_SERVE_CHECKPOINT=${ACOT_SERVE_CHECKPOINT:-/submission/checkpoint/generalist_continued_augumented}
